...
if(results.value==0x1FEE01F){ // For Load1 On
load1 = 0;
EEPROM.write(1, load1);
}
else if(results.value==0x1FE906F){ // For Load1 Off
load1 = 1;
EEPROM.write(1, load1);
}
else if(results.value==0x1FE50AF){ // For Load2 On
load2 = 0;
EEPROM.write(2, load2);
}
else if(results.value==0x1FEF807){ // For Load2 Off
load2 = 1;
EEPROM.write(2, load2);
}
else if(results.value==0x1FE30CF){ // For Load3 On
load3 = 0;
EEPROM.write(3, load3);
}
else if(results.value==0x1FE708F){ // For Load3 Off
load3 = 1;
EEPROM.write(3, load3);
}
else if(results.value==0x1FE00FF){ // For Load4 On
load4 = 0;
EEPROM.write(4, load4);
}
else if(results.value==0x1FE9867){ // For Load4 Off
load4 = 1;
EEPROM.write(4, load4);
}
...
else if(results.value==0x1FE7887){ // For Power Off
power = 1;
EEPROM.write(5, power);
}
